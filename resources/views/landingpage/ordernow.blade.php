    ...
    <div class="container mt-10 bg-white p-12 mx-auto">
        ...
        <div class="flex flex-col w-full px-0 mx-auto md:flex-row">
            <div class="flex flex-col md:w-full">
                ...
                <form class="justify-center w-full mx-auto" method="POST" action="/orderplace">
                    @csrf
                    <div class="">
                        ...
                        <div class="mt-4">
                            <div class="w-full">
                                ...
                                <textarea name="address" class="w-full px-4 py-3 text-xs border border-gray-300 rounded lg:text-sm focus:outline-none focus:ring-1 focus:ring-blue-600" name="Address" cols="20" rows="4" placeholder="Address"></textarea>
                            </div>
                        </div>
                        <div class="space-x-0 lg:flex lg:space-x-4">
                            <div class="w-full lg:w-1/2">
                        ...
                        <div class="relative pt-3 xl:pt-6">
                            ...
                            <textarea name="noted" class="flex items-center w-full px-4 py-3 text-sm border border-gray-300 rounded focus:outline-none focus:ring-1 focus:ring-blue-600" rows="4" placeholder="Notes for delivery"></textarea>
                            <br>
                        </div>
                        <hr>
                        <div class="items-center mt-4">
                            ...
                            <label class="items-center text-sm group text-heading">
                                <input type="radio" value="Credit Card" name="payment" class="w-4 h-4 border border-gray-300 rounded focus:outline-none focus:ring-1">
                                <span class="text-base ml-2">Credit or debit card</span><br><br>
                                <input type="radio" value="COD" name="payment" class="w-4 h-4 border border-gray-300 rounded focus:outline-none focus:ring-1">
                        ...
                        <div class="mt-4">
                            <button type="submit" class="w-full mt-6 px-6 py-2 font-medium text-white bg-blue-600 hover:bg-blue-900">Checkout</button>
                        </div>
                    </div>
                </form>
            </div>
            ...
            <div class="flex flex-col w-full ml-0 lg:ml-12 lg:w-2/5">
                <div class="pt-12 md:pt-0 2xl:ps-4">
                    ...
                    <div class="mt-8">
                        <div class="flex flex-col space-y-4">
                            ...
                            <div class="flex mb-4 space-x-4">
                                <div>
                                    <img src="/product_image/{{$item->img}}" alt="image" class="w-60">
                                </div>
                                <div>
                                    <h2 class="text-xl font-bold">{{$item->product_title}}</h2>
                                    <span class="text-red-600">Rp{{$item->price}}</span>
                                </div>
                                <div>
                                    <a href="/orderremove/{{$item->cart_id}}">
                    ...
                    <div class="flex items-center w-full py-4 text-sm font-semibold border-b border-gray-300 lg:py-5 lg:px-3 text-heading last:border-b-0 last:text-base last:pb-0">
                        Subtotal<span class="ml-2"></span></div>
                    <div class="flex items-center w-full py-4 text-sm font-semibold border-b border-gray-300 lg:py-5 lg:px-3 text-heading last:border-b-0 last:text-base last:pb-0">
